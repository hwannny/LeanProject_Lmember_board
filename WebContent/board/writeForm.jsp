...
<form method="post" action="writePro.jsp" name="writeform" onsubmit="return writecheck()">
	...
	<table>
		...
		<tr> 
			<th> <%=str_writer%> </th> 
			<td>
				<input class="input" type="text" name="writer" maxlength="30" autofocus="autofocus">
			</td>
		</tr>
		<tr>
			<th><%=str_email %></th>
		...
		<tr>
			<th colspan="2">
				...
				<input class="inputbutton" type="button" value="<%=btn_list %>" onclick="location='list.jsp'">
			</th>
		</tr>
	</table>	
</form>
